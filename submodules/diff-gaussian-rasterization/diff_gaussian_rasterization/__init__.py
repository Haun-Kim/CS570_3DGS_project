    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                ...
                elif raster_settings.bw_score:
                    num_rendered, color, radii, geomBuffer, binningBuffer, imgBuffer, important_score = _C.bw_score_gaussians(*args)
                elif raster_settings.mw_score:
                    num_rendered, color, radii, geomBuffer, binningBuffer, imgBuffer, important_score = _C.mw_score_gaussians(*args)
                elif raster_settings.top_K_dT:
                    args += (raster_settings.top_K_dT,)
                    num_rendered, color, radii, geomBuffer, binningBuffer, imgBuffer, important_score = _C.top_k_gaussians(*args)
                else:
