...
class Compact_3DGS(GaussianModel):
    ...
    def densify_and_prune(self, max_grad, min_opacity, extent, max_screen_size, n_split, scene=None, pipe=None, background=None, render=None, opt=None):
    ...
    def prune_after_render(self, opt, iteration, scene=None, pipe=None, background=None, render=None):
